  ...
  return (
    <main className="max-w-4xl mx-auto mt-20 md:mt-40 p-6">
      ...
      <p className="text-gray-700 mb-6 text-justify dark:text-white dark:text-white">
        ...
        (collectively, the “Linqtrim Services”). Please read these Terms of Service
        (the “Agreement”) carefully, as they govern your access to and use of
        the Linqtrim Services and constitute a binding legal agreement between you
        and Linqtrim. If you accept this Agreement or use the Linqtrim Services on
        ...
        granted access to and use of the Linqtrim Services by and on behalf of the
        ...
        Agreement, your use of the Linqtrim Services is governed by the Linqtrim
        Privacy Policy, the Linqtrim Acceptable Use Policy and Linqtrim’s DMCA
        Copyright Policy. YOU ACKNOWLEDGE AND AGREE THAT, BY CREATING A LINQTRIM
        ACCOUNT (“ACCOUNT”), PURCHASING A PAID ACCOUNT, OR ACCESSING OR USING
        THE LINQTRIM SERVICES AND APPLICATION PROGRAM INTERFACES (“API”), YOU ARE
        INDICATING THAT YOU HAVE READ, UNDERSTAND AND AGREE TO BE BOUND BY THE
        TERMS OF THIS AGREEMENT AND THE LINQTRIM ACCEPTABLE USE POLICY. IF YOU DO
        NOT AGREE TO THESE TERMS, THEN YOU HAVE NO RIGHT TO ACCESS OR USE THE
        LINQTRIM SERVICES. THIS AGREEMENT CONTAINS AN ARBITRATION PROVISION AND
      ...
      <p className="text-gray-700 mb-6 text-justify dark:text-white">
        ...
        in the Linqtrim platform. Any change to this Agreement will be effective as
        of the Last Updated Date in at the top of this page. By continuing to
        access or use the Linqtrim Services after the Last Updated Date, you are
        ...
        periodically for changes and that your use of the Linqtrim Services
