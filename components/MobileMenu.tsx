...
const MobileMenu: React.FC<MobileProps> = ({user}) => {
  ...
  return (
    <main>
      ...
      {isOpen && (
        <div className="absolute top-24 left-0 w-full h-[calc(100vh-96px)] items-center justify-center gap-6 z-50 ease-in duration-200 bg-[#2EB77A] flex flex-col justify-center gap-4">
          <Link href="/login">
            <button
